...
<div id="contenitore">
	...
	<div id="content">
		<span class="titoli">Tag - Elenco</span>
		<br />
		<br />
      	<form name="form" method="post">
			
		<?php				 
			$array = $object->getPage(" ", " ORDER BY tag asc", $page);
			...
			?>
				  <table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr class="colore_testata">
                      <td width="7%">&nbsp;</td>	
					  <td class="testo" align="center"><strong>Tag</strong></td>
                      <td width="20%" class="testo" align="center"><strong>Importanza</strong></td>
                    </tr>
					<?php
					  $sfondo = "colore_uno";
						...
						foreach($array as $item)				  
						{
							...
							print "<td class='testo'>". html_entity_decode($item["tag"], ENT_QUOTES, CHARSET) . "</td><td class='testo'>".$item["importanza"];
							print "</tr>";
						}
					  ?>
				  </table>
