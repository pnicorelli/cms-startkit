...
if( strlen($sorting) >0 )
{
	...
	$object->sortingMove($position, $sorting, "sezione='{$sezione}'", "sorting");
}
...
<div id="contenitore">
	...
	<div id="content">
		...
		<?php				 
			...
			$array = $object->getPage(" sezione='{$sezione}' ", " ORDER BY sorting ", $page);
					...
					<?php
					  $sfondo = "colore_uno";
						...
						foreach($array as $item)				  
						{
							...
							print "<a href='".$suffixpage."_elenco.php?position=".$item["sorting"]."&sorting=up&sezione={$sezione}'><img src='img/su.gif' border=0 title='su'></a>&nbsp;";
							print "<a href='".$suffixpage."_elenco.php?position=".$item["sorting"]."&sorting=down&sezione={$sezione}'><img src='img/giu.gif' border=0 title='su'></a>";
							print "</td>";
			...
			?>
				  ...
				  <div align="center">
						...
						?>
					&nbsp;&nbsp;&nbsp;<a href="<?php echo $suffixpage;?>_item.php?sezione=<?php echo $sezione?>"><img src="img/new.gif" border="0" alt="nuova elemento" title="nuovo elemento"></a>
				 </div>
