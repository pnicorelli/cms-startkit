...
if(isset($_GET["del"]) && $_GET["del"] == "si")
{
	if(isset($_POST["id"]))		
	{
		while (list($indexValue, $cancello) = each ($_POST["id"]))  //indexValue � l'indice dell'array id; cancello è la chiave della voce selezionata
...
<div id="contenitore">
	...
	<div id="content">
		<span class="titoli">Blog - Elenco</span>
		<br />
		<br />
      	<form name="form" method="post">
			
		<?php				 
			$array = $object->getPage(" ", " ORDER BY data desc", $page);
			...
			?>
				  <table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr class="colore_testata">
                      <td width="7%">&nbsp;</td>	
					  <td class="testo" align="center"><strong>Titolo</strong></td>
					  <td class="testo" align="center"><strong>Tipologia</strong></td>
					  <td class="testo" align="center"><strong>Data</strong></td>
                    </tr>
					<?php
					  $sfondo = "colore_uno";
						...
						foreach($array as $item)				  
						{
							...
							print "<td class='testo'>". html_entity_decode($item["tipologia"], ENT_QUOTES, CHARSET) . "</td>";
							print "<td class='testo'>". data_ita($item["data"]) . "</td>";
							print "</tr>";
						}
					  ?>
				  </table>
