...
$item = new dboBlog($id);
$objGestioneFile = new GestioneFile("blog","foto");
...
if($update == "update"){
		...
		$objFile = new File();
		$objFile->uploadFile($id, "blog", "foto");
	
		//$foo = new Upload($_FILES["file_1_1"]);
		//$foo->Process("../upload/");
}
        ...
        <div id="tabs">
   		...
   		<div id="tabs-1">
              ...
              <tr>
				...
				<td class="backchiaro"><input type="text" class="input" name="data" id="data" value="<?php print data_ita($data) ?>" />
				</td>
			  </tr>
			  <tr>
			...
			<?php if( $id>0 ) { ?>
			  ...
			  <tr>
				...
				<table width="100%" class="listafoto" cellpadding="2" cellspacing="2">
					...
					<?php
					print $objGestioneFile->campi_dett($id, "listafoto");
					?>
				</table>
				</td>
				</tr><?php
